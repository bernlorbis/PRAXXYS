...
<template>
  <AppLayout title="Video Player">
    <div class="grid grid-cols-6 gap-3">
      <div class="h-[550px] col-span-6 lg:col-span-4">
        <video-player
          :src="source"
      ...
      <div class="col-span-6 lg:col-span-2 pl-6">
        <ul>
          <li
            v-for="(video, key) in videos"
            :key="`video-${key}`"
            class="p-2 text-gray-500 shadow rounded-md"
          >
            <button
              @click="changeVideo(video.source)"
              type="button"
              class="text-semibold text-sm hover:underline"
            >
              {{ video.title }}
            </button>
          </li>
